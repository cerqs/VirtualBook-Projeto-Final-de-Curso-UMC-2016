<%-- 
    Document   : InserirPdf
    Created on : 23/04/2016, 02:58:17
    Author     : guilherme
--%>
...
<body id="background-layout">
    ...
    <div class="section group">
        <div class="col span_1_of_2">
            ...
            <form id="formInserirLivro" action="CriarUploadPdf" method="post" enctype="multipart/form-data">

                <table>
                    <tr>

                        <td><label id="texto">Selecione Um PDF para o livro: </label></td>
                ...
                <input type="submit" class="submit" value ="Adicionar" name="acao">                        
            </form> 
